...
const Leaderboard = () => {
  ...
  const fetchTopUsers = async () => {
    try {
      const response = await axios.get('http://localhost:8080/usercontrol/top-users');
  ...
  const fetchUserStats = async () => {
    try {
      const response = await axios.get(`http://localhost:8080/usercontrol/user-rank/TestUser2`);
